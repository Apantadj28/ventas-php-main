<hader class="navbar navbar-expand-lg navbar-dark bg-primary mb-2 shadow rounded">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="img/perueventos.png" alt="" width="150" height="40" class="d-inline-block align-text-top">
    </a>
